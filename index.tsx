...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            cookieMessage: 'We use cookies to enhance your browsing experience and analyze our traffic. By clicking "Accept", you consent to our use of cookies.',
        ...
        ar: {
            ...
            cookieMessage: 'نحن نستخدم ملفات تعريف الارتباط لتحسين تجربة التصفح الخاصة بك وتحليل حركة المرور لدينا. بالنقر على "قبول"، فإنك توافق على استخدامنا لملفات تعريف الارتباط.',
    ...
    // --- Centralized Form Submission URLs ---
    const FORM_SUBMISSION_URLS = {
        contact: 'https://script.google.com/macros/s/AKfycbxUS76iFHL00oqCytiDjvpPfY9wONwwttdI00R6nhhoAkyED2ogZviUb3yXXRDAqAs7tg/exec',
        student: 'https://script.google.com/macros/s/AKfycbwHIEFWVu-5cIqrbW8pV5MSobkrTEq05kxi7aTcIwkfAGpC6ulVoo3tlrq16y3qoZXs/exec',
        booth: 'https://script.google.com/macros/s/AKfycbxW3MBK-rPB1L2rOKMQ9mqkeGagcrnDcFpT7cZYvEFy4WzNxxnU2ZzLnMAQGwvSZZaQ/exec',
        sponsorship: 'https://script.google.com/macros/s/AKfycbwq3S7GQikOlmmWhh5d3aIkC8uTWtIG6UnXcaPzmwdlZ8m5b3kIRKgafYW9zQV1rB-u/exec',
        speaker: 'https://script.google.com/macros/s/AKfycbzObRjQD4ck7tQ02_N9IY9SWtXWFGCVUhrq8eSmGsC7jC1rnSrY2rXe3npuuwgTEnJd/exec',
        schoolGroup: 'https://script.google.com/macros/s/AKfycbzgCIAubolBckuU5yjgeThOWg4iI4pVPDtkMt-jMI1murfQf_Vbah8k7EKWaTT-89cICA/exec',
        hackathon: 'https://script.google.com/macros/s/AKfycbzL5gAJ3wL06k6-2N6_f0j7Vq-1F-9a8E_d7kCj3b-gH_iG-1kL_wZ-jI-9/exec',
        deckRequest: 'https://script.google.com/macros/s/AKfycbzcmND809zEePZzvOLxxM1GolqWM1Lrh11JV9tdprNxSgkp-u0sjlxRzqXtmjDQDtn_2Q/exec'
    };
    ...
    function initializeContactForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.contact;
    ...
    function initializeStudentRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid && areCheckboxesValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.student;
    ...
    function initializeBoothRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.booth;
    ...
    function initializeSponsorshipRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.sponsorship;
    ...
    function initializeSpeakerRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid && isCustomValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.speaker;
    ...
    function initializeSchoolGroupRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.schoolGroup;
    ...
    function initializeHackathonRegistrationForm() {
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.hackathon; 
    ...
    function initializeDeckRequestForm() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            if (isFormValid) {
                ...
                const googleSheetWebAppUrl = FORM_SUBMISSION_URLS.deckRequest;
    ...
    // --- NEW: Blog Post Reading Progress Bar ---
    function initializeReadingProgressBar() {
        ...
        const updateProgressBar = () => {
            ...
            const totalHeight = contentRect.height - window.innerHeight;
    ...
    // --- NEW: Blog Post Copy Link Functionality ---
    function initializeCopyLinkButtons() {
        const copyButtons = document.querySelectorAll('#copy-link-button, #copy-link-button-inline');
        ...
        copyButtons.forEach(button => {
            button.addEventListener('click', () => {
                navigator.clipboard.writeText(window.location.href).then(() => {
                    ...
                    (button as HTMLElement).style.backgroundColor = '#4db6ac'; // A success color
    ...
    function initializeCookieBanner() {
        ...
        // Populate and show the banner. All logic and conditions are removed for UI review.
        banner.innerHTML = `
